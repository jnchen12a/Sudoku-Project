...
def draw_game_screen(screen, board):
  ...
  reset_rectangle = reset_surface.get_rect(center=(WIDTH // 4, BOARD_LENGTH + 37.5))
  restart_rectangle = restart_surface.get_rect(center=((WIDTH // 4) * 2, BOARD_LENGTH + 37.5))
  exit_rectangle = exit_surface.get_rect(center=((WIDTH // 4) * 3, BOARD_LENGTH + 37.5))
  # Drawing buttons
...
def draw_win_screen(screen):
  ...
  screen.bilt(end_title_surface, end_rectange)
...
def draw_lost_screen(screen):
  ...
  restart_surface.bilt(restart_text, (10, 10))
  
  #Initialize Button Rectangle
  restart_rectangle = restart_surface.get_rect(center=(WIDTH // 2, SCREEN_LENGTH // 2 + 50))
  
  #Draws Buttons
  screen.bilt(restart_surface, restart_rectangle)
...
if __name__ == '__main__':
  ...
  num_removed_cells = 30 # Update this
